     ...
     <div class="row">
       <section class="posts col-md-9">
         <div class="miga-de-pan">
           <ol class="breadcrumb">
             <li class="active">REPORTE DE TEMPERATURA</li>
           </ol>
		      </div>
		   </section>
      </div>         
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="imag/77.jpg" alt="Los Angeles">
    </div>

    <div class="item">
      <img src="imag/33.jpg" alt="Chicago">
    </div>

    <div class="item">
      <img src="imag/44.jpg" alt="New York">
    </div>
  </div>
  ...
  <div style="margin:50px;">
      ...
      <h3>REPORTE DEL SENSOR DE TEMPERATURA</h3>
      ...
      <table class="tablejquery table table-striped table-bordered" cellspacing="0" width="100%">
          ...
          <tr>
              <th>Nro</th>
              <th>Dato de la temperatura del agua</th>
              <th>Hora</th>
              <th>Fecha</th>
          </tr>
          </thead>
  ...
  <script type="text/javascript">
      ...
      function drawChart() {
          var data = google.visualization.arrayToDataTable([
              ...
              for($x=1;$x<=4;$x++){
              ?>
              ['<?php echo $meses[$x]; ?>', <?php echo $nivel[$x] ?>],
              <?php } ?>
          ]);

          var options = {
              chart: {
                  title: 'Gráfica de nivel del pH (Potencial Hidrogeno)',
                  subtitle: 'Alcalino y básico',
              }
          };
  ...
  $sql="    SELECT id_registro, da_temperatura,fecha_a 
            FROM registro      
       ";
